...
export default function NotFound() {
	...
	return (
		<div className='h-screen relative overflow-hidden m-0'>
			...
			{/* Main Content */}
			<div className='relative z-30 flex items-center justify-center h-[85vh] py-0 p-4'>
					...
					<CardContent className='p-10 text-center space-y-8'>
						...
						<div className='space-y-4 animate-fade-in'>
							<h2 className='text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 dark:from-white dark:to-slate-300 bg-clip-text text-transparent'>
								Oops! This Blog Was Not Found
							</h2>
							<p className='text-slate-600 dark:text-slate-400 leading-relaxed text-lg'>
								Sorry, Blog page you{`'`}re looking for doesn{`'`}t exist. It
